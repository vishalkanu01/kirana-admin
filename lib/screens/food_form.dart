...
//    _imageUrl = _currentFood.image;
  ...
  Widget _buildDetailsField() {
    return TextFormField(
      ...
      initialValue: _currentFood.details,
      keyboardType: TextInputType.text,
      style: TextStyle(fontSize: 20),
      validator: (String value) {
        if (value.isEmpty) {
        ...
        if (value.length < 3 || value.length > 500) {
          return 'Details must be more than 3 and less than 100';
        }

        return null;
      },
      onSaved: (String value) {
        _currentFood.details = value;
      },
    );
  }
  ...
  _saveFood() {
    ...
    print("details: ${_currentFood.details}");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,
      appBar: AppBar(title: Text('Prdouct  Form')),
